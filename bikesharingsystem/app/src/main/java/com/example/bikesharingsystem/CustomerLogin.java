    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabase.getInstance().getReference("Users").child("Customers").child(uid).addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                       ...
                       {
                           Toast.makeText(CustomerLogin.this, "Password invalid !", Toast.LENGTH_SHORT).show();
                       }
                    }
