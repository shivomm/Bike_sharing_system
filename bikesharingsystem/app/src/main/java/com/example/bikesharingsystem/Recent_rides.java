...
public class Recent_rides extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayAdapter<String> myArrayAdapter=new ArrayAdapter<String>(Recent_rides.this,R.layout.mytextview,myArrayList);
        mylist=findViewById(R.id.listView1);
        mylist.setAdapter(myArrayAdapter);
        final String uid= FirebaseAuth.getInstance().getCurrentUser().getUid();
        ref= FirebaseDatabase.getInstance().getReference().child("Requests").child(uid);
        //String details;
