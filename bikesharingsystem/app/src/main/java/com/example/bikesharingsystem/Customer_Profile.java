...
public class Customer_Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mrecentRide.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),Recent_rides.class));
            }
        });
...
private void setUserProfileImage(Uri uri)
{
    ...
    user.updateProfile(request).addOnSuccessListener(new OnSuccessListener<Void>() {
        ...
        public void onSuccess(Void aVoid) {
            Toast.makeText(Customer_Profile.this, "Updated Successfully", Toast.LENGTH_SHORT).show();
        }
    })
            .addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Customer_Profile.this, "Profile image failed", Toast.LENGTH_SHORT).show();
                }
            });
}
