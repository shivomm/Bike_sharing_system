...
public class RphoneAuth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rphone_auth);
        ...
        if(FirebaseAuth.getInstance().getCurrentUser() != null)
        {
            ...
            DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Riders");
            rootRef.child(uid);
    ...
    private void verifyAuth(PhoneAuthCredential credential) {
        fauth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                {
                    Toast.makeText(RphoneAuth.this, "Authentication failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void checkforPhoneNumber(final String phone) {
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    startActivity(new Intent(RphoneAuth.this, RiderLogin.class));
                    finish();
                }
                else {
                    ...
                    FirebaseDatabase.getInstance().getReference().child("Users").child("Riders").child(uid).child("phoneno").setValue(phoneNum);
                    Toast.makeText(RphoneAuth.this, "Authentication is successful", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(RphoneAuth.this,RiderSignUp.class));
                    finish();
                }
            }
    ...
    private void requestOTP(String phoneNum)
    {
        PhoneAuthProvider.getInstance().verifyPhoneNumber(phoneNum, 60L, TimeUnit.SECONDS, this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                Toast.makeText(RphoneAuth.this, "Cannot create account" +e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
